...
def parse_opts():
    ...
    parser.add_argument('--data_path',
                    type=Path,
                    required=True,
                    help='Percorso alla directory con i dati preprocessati (clip con images.pt)')
    ...
    parser.add_argument('--teacher_pretrain_path', #############
                        default=None,
                        type=Path,
                        help='Pretrained model teacher path (.pth).')
    parser.add_argument('--student_pretrain_path', #############
                        default=None,
                        type=Path,
                        help='Pretrained model student path (.pth).')
    parser.add_argument(
        '--ft_begin_module',
        default='',
        type=str,
    ...
    parser.add_argument( #un tipo di scheduler che abbassa la learning rate a specifiche epoche.
    ...
    parser.add_argument( #Attiva la synchronization dei BatchNorm tra più GPU (solo utile con distributed training).
        '--batchnorm_sync',
        action='store_true',
    ...
    parser.add_argument('--alpha', type=float, default=0.9,
                    help='Peso della loss del teacher (soft label). 1.0 = solo soft, 0.0 = solo hard.')
    parser.add_argument('--temperature', type=float, default=4.0,
                    help='Temperatura per ammorbidire le softmax del teacher/student.')
